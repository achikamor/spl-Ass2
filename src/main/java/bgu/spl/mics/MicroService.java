...
public abstract class MicroService implements Runnable {
    ...
    private ConcurrentHashMap<Class<? extends Message>, Callback> MChashmap = new ConcurrentHashMap<>();
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        if (MChashmap.get(type) == null)//if it was not added before
            MChashmap.put(type, callback);
    }
     ...
     *               {@code e}.
     */
    protected synchronized final <T> void complete(Event<T> e, T result) {
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                ...
                Callback callback= MChashmap.get(message.getClass());
