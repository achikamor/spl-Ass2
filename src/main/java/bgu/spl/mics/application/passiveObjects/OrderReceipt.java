...
public class OrderReceipt implements Serializable {
	...
	public OrderReceipt(int orderId,String seller,int customer,String bookTitle,int price,int proccessTick){
	...
	/**
	 *
	 * @param tick,is a param that we would like to add to the receipt
	 */
